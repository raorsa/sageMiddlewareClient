...
class Articles extends GenericClient
{
    ...
    public function screwTips(bool $cache = true): object|false
    {
        return $this->callJson(implode('/', [self::BASE, self::SCREWTIP, 'list']), $cache);
    }

    public function findScrewTips(string $diameter, bool $cache = true): object|false
    {
        return $this->callJson(implode('/', [self::BASE, self::SCREWTIP, 'find', $diameter]), $cache);
    }

    public function searchScrewTips(array $diameters, bool $cache = true): object|false
    {
